...
-- Após criação, adicionamos a restrição de mutualidade
...
-- A ordem de inserção importa por ter supervisor como chave estrangeira
...
-- Agora que os empregados foram inseridos, é possível inserir a chave estrangeira de departamento
UPDATE DEPARTMENT
